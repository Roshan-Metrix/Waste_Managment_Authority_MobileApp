...
//   const itemOptions = ["Plastic", "Tin", "Steel", "Copper", "Paper", "Glass"];
...
//           {/* Manager + Vendor */}
//           <Text style={styles.label}>Manager: {profile?.email || "Loading..."}</Text>
...
//                 >
//                   <MaterialIcons name="photo-camera" size={40} color="#2563eb" />
//                   <Text style={{ color: "#2563eb" }}>Open Camera</Text>
//                 </TouchableOpacity>
//               ) : (
//                 <CameraView
...
//           {/* ITEM DROPDOWN */}
//           <Text style={styles.subHeading}>Select Item Type</Text>
...
//           {/* Vendor Image + Signature Button */}
//           <View style={styles.vendorRow}>
//             <Image
//               source={{ uri: "https://picsum.photos/70" }} // dummy vendor image
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f9fafb" }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        {/* BILL LAYOUT */}
        <View style={styles.billBox}>
          <Text style={styles.storeName}>{store?.name || "Store Name Loading..."}</Text>
          <Text style={styles.storeLocation}>
            {store?.storeLocation || "Location Loading..."}
          </Text>
          ...
          <Text style={styles.disclaimer}>* Above bill is true and correct *</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  subHeading: { fontSize: 18, fontWeight: "700", marginTop: 20, marginBottom: 10 },
  ...
  disclaimer: { marginTop: 20, fontSize: 12, textAlign: "center", color: "#777" },
  ...
  permissionBtn: { backgroundColor: "#2563eb", padding: 12, borderRadius: 8 },
});
